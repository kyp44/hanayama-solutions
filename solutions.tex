...
\begin{enumerate}
      \item Fit and hold the inner ring along with the half rings according to the model below.
            The \hhalf{} should be on the right with its label facing up, and the Valve left on the right with its label facing down, in the same general orientation as for the disassembly.
      ...
      \item Rotate the inner ring clockwise two segments until it stops and the outer ring one segment clockwise.
